...
type Attendance struct {
	...
	CheckOut   string    `gorm:"not null;size:5" json:"check_out" validate:"required,datetime=15:04"`
	Status     string    `gorm:"not null;size:10;default:PRESENT" json:"status" validate:"required,oneof=PRESENT LATE ABSENT"`
